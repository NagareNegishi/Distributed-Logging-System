...
import io.github.nagare.logging.log4j.MemAppender;
 ...
 * mvn exec:java -Dexec.mainClass="io.github.nagare.logging.example.LogRunner_MemAppender"
 */
public class LogRunner_MemAppender {

    private static final Logger logger = Logger.getLogger(LogRunner_MemAppender.class);
